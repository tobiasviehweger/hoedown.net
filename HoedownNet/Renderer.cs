...
namespace Hoedown
{
    ...
    internal struct md_callbacks
    {
        ...
        public IntPtr footnotes;
        public IntPtr footnote_def;
    ...
    internal struct md_sharpcallbacks
    {
        ...
        public mkd_renderer_footnotes footnotes;
        public mkd_renderer_footnote_def footnote_def;
        ...
        public mkd_renderer_underline underline;
        public mkd_renderer_highlight highlight;
        public mkd_renderer_quote quote;
        ...
        public mkd_renderer_footnote_ref footnote_ref;
    ...
    delegate void mkd_renderer_footnotes(IntPtr ob, IntPtr text, IntPtr opaque);
    delegate void mkd_renderer_footnote_def(IntPtr ob, IntPtr text, int num, IntPtr opaque);
    ...
    delegate int mkd_renderer_underline(IntPtr ob, IntPtr text, IntPtr opaque);
    delegate int mkd_renderer_highlight(IntPtr ob, IntPtr text, IntPtr opaque);
    delegate int mkd_renderer_quote(IntPtr ob, IntPtr text, IntPtr opaque);
    ...
    delegate int mkd_renderer_footnote_ref(IntPtr ob, int num, IntPtr opaque);
    ...
    public class Renderer
    {
        ...
        internal Renderer(bool initialize = false)
        {
            ...
            this_callbacks.footnotes = mkd_renderer_footnotes;
            this_callbacks.footnote_def = mkd_renderer_footnote_def;
            ...
            this_callbacks.underline = mkd_renderer_underline;
            this_callbacks.highlight = mkd_renderer_highlight;
            this_callbacks.quote = mkd_renderer_quote;
            ...
            this_callbacks.footnote_ref = mkd_renderer_footnote_ref;
        ...
        protected virtual void Initialize()
        {
            ...
            if (callbacks.footnotes != IntPtr.Zero) base_callbacks.footnotes = Marshal.GetDelegateForFunctionPointer(callbacks.footnotes, typeof(mkd_renderer_footnotes)) as mkd_renderer_footnotes;
            if (callbacks.footnote_def != IntPtr.Zero) base_callbacks.footnote_def = Marshal.GetDelegateForFunctionPointer(callbacks.footnote_def, typeof(mkd_renderer_footnote_def)) as mkd_renderer_footnote_def;
            ...
            if (callbacks.underline != IntPtr.Zero) base_callbacks.underline = Marshal.GetDelegateForFunctionPointer(callbacks.underline, typeof(mkd_renderer_underline)) as mkd_renderer_underline;
            if (callbacks.highlight != IntPtr.Zero) base_callbacks.highlight = Marshal.GetDelegateForFunctionPointer(callbacks.highlight, typeof(mkd_renderer_highlight)) as mkd_renderer_highlight;
            if (callbacks.quote != IntPtr.Zero) base_callbacks.quote = Marshal.GetDelegateForFunctionPointer(callbacks.quote, typeof(mkd_renderer_quote)) as mkd_renderer_quote;
            ...
            if (callbacks.footnote_ref != IntPtr.Zero) base_callbacks.footnote_ref = Marshal.GetDelegateForFunctionPointer(callbacks.footnote_ref, typeof(mkd_renderer_footnote_ref)) as mkd_renderer_footnote_ref;
            ...
            if (IsOverriden("Footnotes")) callbacks.footnotes = Marshal.GetFunctionPointerForDelegate(this_callbacks.footnotes);
            if (IsOverriden("FootnoteDef")) callbacks.footnote_def = Marshal.GetFunctionPointerForDelegate(this_callbacks.footnote_def);
            ...
            if (IsOverriden("Underline")) callbacks.underline = Marshal.GetFunctionPointerForDelegate(this_callbacks.underline);
            if (IsOverriden("Highlight")) callbacks.highlight = Marshal.GetFunctionPointerForDelegate(this_callbacks.highlight);
            if (IsOverriden("Quote")) callbacks.quote = Marshal.GetFunctionPointerForDelegate(this_callbacks.quote);
            ...
            if (IsOverriden("FootnoteRef")) callbacks.footnote_ref = Marshal.GetFunctionPointerForDelegate(this_callbacks.footnote_ref);
        ...
        protected virtual void FootnoteDef(Buffer ob, Buffer text, int flags)
        {
            if (base_callbacks.footnote_def != null)
            {
                base_callbacks.footnote_def(ob.NativeHandle, text.NativeHandle, flags, opaque);
            }
        }

        private void mkd_renderer_footnote_def(IntPtr ob, IntPtr text, int num, IntPtr opaque)
        {
            FootnoteDef(Buffer.From(ob), Buffer.From(text), num);
        }

        protected virtual void Footnotes(Buffer ob, Buffer text)
        {
            if (base_callbacks.footnotes != null)
            {
                base_callbacks.footnotes(ob.NativeHandle, text.NativeHandle, opaque);
            }
        }

        private void mkd_renderer_footnotes(IntPtr ob, IntPtr text, IntPtr opaque)
        {
            Footnotes(Buffer.From(ob), Buffer.From(text));
        }
        ...
        protected virtual bool Quote(Buffer ob, Buffer text)
        {
            if (base_callbacks.quote != null)
            {
                return base_callbacks.quote(ob.NativeHandle, text.NativeHandle, opaque) != 0;
            }

            return false;
        }

        private int mkd_renderer_quote(IntPtr ob, IntPtr text, IntPtr opaque)
        {
            return Quote(Buffer.From(ob), Buffer.From(text)) ? 1 : 0;
        }

        protected virtual bool Highlight(Buffer ob, Buffer text)
        {
            if (base_callbacks.highlight != null)
            {
                return base_callbacks.highlight(ob.NativeHandle, text.NativeHandle, opaque) != 0;
            }

            return false;
        }

        private int mkd_renderer_highlight(IntPtr ob, IntPtr text, IntPtr opaque)
        {
            return Highlight(Buffer.From(ob), Buffer.From(text)) ? 1 : 0;
        }

        protected virtual bool Underline(Buffer ob, Buffer text)
        {
            if (base_callbacks.underline != null)
            {
                return base_callbacks.underline(ob.NativeHandle, text.NativeHandle, opaque) != 0;
            }

            return false;
        }

        private int mkd_renderer_underline(IntPtr ob, IntPtr text, IntPtr opaque)
        {
            return Underline(Buffer.From(ob), Buffer.From(text)) ? 1 : 0;
        }

        protected virtual bool FootnoteRef(Buffer ob, int num)
        {
            if (base_callbacks.footnote_ref != null)
            {
                return base_callbacks.footnote_ref(ob.NativeHandle, num, opaque) != 0;
            }

            return false;
        }

        private int mkd_renderer_footnote_ref(IntPtr ob, int num, IntPtr opaque)
        {
            return FootnoteRef(Buffer.From(ob), num) ? 1 : 0;
        }
